...
@Component("VehicleIncidentInfoAdaptor")
@Slf4j
public class VehicleIncidentInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param vehicleIncidentInfo 送信するデータモデル
     * @param transaction トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object vehicleIncidentInfo, UUID tracking, String queryParam, String token) {
        return null;
    }
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object vehicleIncidentInfo, UUID tracking, String queryParam, String token) {
        log.info("Send PUT to XXX service. Tracking = {}", tracking);
        ResponseEntity<Void> result;
            String url = baseUrl + "/vehicleIncidentInfo";
