...
import net.ouranos.domain.digiline.model.DataModelDynamicInfoAttribute;
...
/**
 * 車両情報連携システムで保持する動的情報のデータモデル
 */

@Schema(name = "dynamicInfo", description = "車両情報連携システムで保持する動的情報のデータモデル")
@JsonTypeName("dynamicInfo")
...
public class DynamicInfo {
  ...
  private DataModelDynamicInfoAttribute attribute;
   ...
   */
  public DynamicInfo(DataModelDynamicInfoAttribute attribute) {
    this.attribute = attribute;
  }

  public DynamicInfo dataModelType(DataModelTypeEnum dataModelType) {
  ...
  */
  ...
  public DynamicInfo attribute(DataModelDynamicInfoAttribute attribute) {
    this.attribute = attribute;
    return this;
  }
  ...
  */
  ...
  public DataModelDynamicInfoAttribute getAttribute() {
    return attribute;
  }

  public void setAttribute(DataModelDynamicInfoAttribute attribute) {
    this.attribute = attribute;
  }
  ...
  public boolean equals(Object o) {
    ...
    DynamicInfo dynamicInfo = (DynamicInfo) o;
    return Objects.equals(this.dataModelType, dynamicInfo.dataModelType) &&
        Objects.equals(this.attribute, dynamicInfo.attribute);
  }
