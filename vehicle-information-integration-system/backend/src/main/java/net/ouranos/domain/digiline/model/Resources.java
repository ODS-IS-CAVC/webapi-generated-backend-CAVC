...
import net.ouranos.domain.digiline.model.DataModelResourcesAttribute;
...
/**
 * C-2-2[B] 共有資源状態データモデル
 */

@Schema(name = "resources", description = "C-2-2[B] 共有資源状態データモデル")
...
public class Resources {
  ...
  private DataModelResourcesAttribute attribute;
   ...
   */
  public Resources(DataModelTypeEnum dataModelType, DataModelResourcesAttribute attribute) {
    this.dataModelType = dataModelType;
    this.attribute = attribute;
  }

  public Resources dataModelType(DataModelTypeEnum dataModelType) {
    this.dataModelType = dataModelType;
    return this;
  }
  ...
  */
  ...
  public Resources attribute(DataModelResourcesAttribute attribute) {
    this.attribute = attribute;
    return this;
  }
  ...
  */
  ...
  public DataModelResourcesAttribute getAttribute() {
    return attribute;
  }

  public void setAttribute(DataModelResourcesAttribute attribute) {
    this.attribute = attribute;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataModelType, resources.dataModelType) &&
        Objects.equals(this.attribute, resources.attribute);
  }
