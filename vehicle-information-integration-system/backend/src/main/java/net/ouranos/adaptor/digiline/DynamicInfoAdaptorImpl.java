...
/**
 * DynamicInfoAdaptor実装クラス。
 */
@Component("DynamicInfoAdaptor")
@Slf4j
public class DynamicInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/dynamicInfo";
