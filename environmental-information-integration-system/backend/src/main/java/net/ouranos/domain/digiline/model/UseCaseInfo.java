...
import net.ouranos.domain.digiline.model.DataModelUseCaseInfoAttribute;
...
@Schema(name = "useCaseInfo", description = "ユースケース情報")
@JsonTypeName("useCaseInfo")
...
public class UseCaseInfo {
  ...
  private DataModelUseCaseInfoAttribute attribute;

  public UseCaseInfo dataModelType(DataModelTypeEnum dataModelType) {
  ...
  */
  ...
  public UseCaseInfo attribute(DataModelUseCaseInfoAttribute attribute) {
  ...
  */
  ...
  public DataModelUseCaseInfoAttribute getAttribute() {
    return attribute;
  }

  public void setAttribute(DataModelUseCaseInfoAttribute attribute) {
    this.attribute = attribute;
  }
  ...
  public boolean equals(Object o) {
    ...
    UseCaseInfo useCaseInfo = (UseCaseInfo) o;
    return Objects.equals(this.dataModelType, useCaseInfo.dataModelType) &&
        Objects.equals(this.attribute, useCaseInfo.attribute);
  }
