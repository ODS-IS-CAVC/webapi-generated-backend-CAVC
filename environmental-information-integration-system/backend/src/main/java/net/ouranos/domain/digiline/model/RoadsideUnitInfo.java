...
import net.ouranos.domain.digiline.model.DataModelRoadsideUnitInfoAttribute;
...
@Schema(name = "roadsideUnitInfo", description = "路側機属性情報")
@JsonTypeName("roadsideUnitInfo")
...
public class RoadsideUnitInfo {
  ...
  private DataModelRoadsideUnitInfoAttribute attribute;

  public RoadsideUnitInfo dataModelType(DataModelTypeEnum dataModelType) {
  ...
  */
  ...
  public RoadsideUnitInfo attribute(DataModelRoadsideUnitInfoAttribute attribute) {
  ...
  */
  ...
  public DataModelRoadsideUnitInfoAttribute getAttribute() {
    return attribute;
  }

  public void setAttribute(DataModelRoadsideUnitInfoAttribute attribute) {
    this.attribute = attribute;
  }
  ...
  public boolean equals(Object o) {
    ...
    RoadsideUnitInfo roadsideUnitInfo = (RoadsideUnitInfo) o;
    return Objects.equals(this.dataModelType, roadsideUnitInfo.dataModelType) &&
        Objects.equals(this.attribute, roadsideUnitInfo.attribute);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoadsideUnitInfo {\n");
