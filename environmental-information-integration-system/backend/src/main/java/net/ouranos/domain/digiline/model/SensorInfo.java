...
import net.ouranos.domain.digiline.model.DataModelSensorInfoAttribute;
...
@Schema(name = "sensorInfo", description = "路側機に接続されているセンサ情報")
@JsonTypeName("sensorInfo")
...
public class SensorInfo {
  ...
  private DataModelSensorInfoAttribute attribute;

  public SensorInfo dataModelType(DataModelTypeEnum dataModelType) {
  ...
  */
  ...
  public SensorInfo attribute(DataModelSensorInfoAttribute attribute) {
  ...
  */
  ...
  public DataModelSensorInfoAttribute getAttribute() {
    return attribute;
  }

  public void setAttribute(DataModelSensorInfoAttribute attribute) {
    this.attribute = attribute;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataModelType, sensorInfo.dataModelType) &&
        Objects.equals(this.attribute, sensorInfo.attribute);
  }
