...
/**
 * AliveMonitoringInfoAdaptor実装クラス例。
 */
@Slf4j
@Component("AliveMonitoringInfoAdaptor")
public class AliveMonitoringInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/aliveMonitoringInfo";
     ...
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelAliveMonitoringInfo, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            ...
            .body(dataModelAliveMonitoringInfo)
            .retrieve()
            .toEntity(Object.class);
        } else {
            String url = baseUrl + "/aliveMonitoringInfo";
