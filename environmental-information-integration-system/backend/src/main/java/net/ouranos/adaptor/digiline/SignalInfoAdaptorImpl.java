...
@Component("SignalInfoAdaptor")
@Slf4j
public class SignalInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param dataModelSignalInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelSignalInfo, UUID tracking, String queryParam, String token) {
