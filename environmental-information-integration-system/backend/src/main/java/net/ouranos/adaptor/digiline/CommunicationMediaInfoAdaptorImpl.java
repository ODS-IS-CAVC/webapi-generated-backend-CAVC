...
@Component("CommunicationMediaInfoAdaptor")
@Slf4j
public class CommunicationMediaInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/communicationMediaInfo";
     ...
     *
     * @param dataModelCommunicationMediaInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelCommunicationMediaInfo, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            ...
            .body(dataModelCommunicationMediaInfo)
            .retrieve()
            .toEntity(Object.class);
        } else {
            String url = baseUrl + "/communicationMediaInfo";
