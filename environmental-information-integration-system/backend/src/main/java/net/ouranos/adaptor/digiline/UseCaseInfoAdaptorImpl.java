...
@Component("UseCaseInfoAdaptor")
@Slf4j
public class UseCaseInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param UseCaseDataModel 取得対象のデータモデル
     ...
     */
    @Override
    public ResponseEntity<Object> sendGet(String UseCaseDataModel, UUID tracking, String queryParam, String token) {
        log.info("Send GET to XXX service. Tracking = {}", tracking);
        ResponseEntity<Object> result;
        if(queryParam == null) {
            String url = baseUrl + "/useCaseInfo";
     ...
     *
     * @param dataModelUseCaseInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelUseCaseInfo, UUID tracking, String queryParam, String token) {
