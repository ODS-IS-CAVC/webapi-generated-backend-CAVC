...
@Component("TargetInfoAdaptor")
@Slf4j
public class TargetInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param dataModelTargetInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelTargetInfo, UUID tracking, String queryParam, String token) {
