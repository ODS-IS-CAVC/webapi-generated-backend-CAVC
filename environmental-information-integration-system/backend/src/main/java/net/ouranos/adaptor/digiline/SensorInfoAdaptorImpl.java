...
@Component("SensorInfoAdaptor")
@Slf4j
public class SensorInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param dataModelSensorInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelSensorInfo, UUID tracking, String queryParam, String token) {
