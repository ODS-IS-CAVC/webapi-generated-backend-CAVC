...
@Component("ServiceLocationInfoAdaptor")
@Slf4j
public class ServiceLocationInfoAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     *
     * @param ServiceLocationDataModel 取得対象のデータモデル
     ...
     */
    @Override
    public ResponseEntity<Object> sendGet(String ServiceLocationDataModel, UUID tracking, String queryParam, String token) {
        log.info("Send GET to XXX service. Tracking = {}", tracking);
        ResponseEntity<Object> result;
        if(queryParam == null) {
            String url = baseUrl + "/serviceLocationInfo";
     ...
     *
     * @param dataModelServiceLocationInfo 送信するデータモデル
     * @param tracking トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object dataModelServiceLocationInfo, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            ...
            .body(dataModelServiceLocationInfo)
            .retrieve()
            .toEntity(Object.class);
        } else {
            String url = baseUrl + "/serviceLocationInfo";
