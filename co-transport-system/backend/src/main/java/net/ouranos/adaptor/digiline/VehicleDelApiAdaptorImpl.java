...
@Component("VehicleDelApiAdaptor")
@Slf4j
public class VehicleDelApiAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     */
    @Override
    public ResponseEntity<Object> sendPut(Object VehicleDel, UUID tracking, String queryParam, String token) {
        return null;
    }
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object vehicleDel, UUID tracking, String queryParam, String token) {
        log.info("Send PUT to XXX service. Tracking = {}", tracking);
        ResponseEntity<Void> result;
            String url = baseUrl + "/vehicle_del";
