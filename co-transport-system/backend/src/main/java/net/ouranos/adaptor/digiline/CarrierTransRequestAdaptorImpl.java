...
@Component("CarrierTransRequestAdaptor")
@Slf4j
public class CarrierTransRequestAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/carrier_trans_request";
    ...
    /**
     * 
     * @param dataModelCarrierTransRequest 送信するデータモデル
     * @param transaction トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object DataModelCarrierTransRequest, UUID tracking, String queryParam, String token) {
        return null;
    }
  ...
  /**
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object dataModelCarrierTransRequest, UUID tracking, String queryParam, String token) {
        ...
        ResponseEntity<Void> result;
            ...
            .body(dataModelCarrierTransRequest)
            .retrieve()
            .toBodilessEntity(); 
            HttpStatusCode statusCode = result.getStatusCode();
            HttpHeaders headers = new HttpHeaders();
