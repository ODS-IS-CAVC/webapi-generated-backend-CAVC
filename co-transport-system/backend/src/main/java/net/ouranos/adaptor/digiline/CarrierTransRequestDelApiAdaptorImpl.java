...
@Component("CarrierTransRequestDelApiAdaptor")
@Slf4j
public class CarrierTransRequestDelApiAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    /**
     * 
     * @param carrierTransRequestDel 送信するデータモデル
     * @param transaction トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object CarrierTransRequestDel, UUID tracking, String queryParam, String token) {
        return null;
    }
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object carrierTransRequestDel, UUID tracking, String queryParam, String token) {
        log.info("Send PUT to XXX service. Tracking = {}", tracking);
        ResponseEntity<Void> result;
            String url = baseUrl + "/carrier_trans_request_del";
