...
@Component("VehicleAdaptor")
@Slf4j
public class VehicleAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     */
    @Override
    public ResponseEntity<Object> sendPut(Object Vehicle, UUID tracking, String queryParam, String token) {
        return null;
    }
  ...
  /**
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object vehicle, UUID tracking, String queryParam, String token) {
