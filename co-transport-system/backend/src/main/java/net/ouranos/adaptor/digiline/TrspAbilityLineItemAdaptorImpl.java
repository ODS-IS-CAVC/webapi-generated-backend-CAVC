...
@Component("TrspAbilityLineItemAdaptor")
@Slf4j
public class TrspAbilityLineItemAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     */
    @Override
    public ResponseEntity<Object> sendPut(Object object, UUID tracking, String queryParam, String token) {
        log.info("Send PUT to XXX service. Tracking = {}", tracking);
        ResponseEntity<Object> result;
        if(queryParam == null) {
            String url = baseUrl + "/trsp_ability_line_item";
