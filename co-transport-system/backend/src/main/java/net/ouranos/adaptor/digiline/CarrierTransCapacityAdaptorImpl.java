...
@Component("CarrierTransCapacityAdaptor")
@Slf4j
public class CarrierTransCapacityAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/carrier_trans_capacity";
    ...
    /**
     * 
     * @param dataModelCarrierTransCapacity 送信するデータモデル
     * @param transaction トランザクションID
     * @param queryParam クエリパラメータ
     * @param token アクセストークン
     * @return サーバーからのレスポンス
     */
    @Override
    public ResponseEntity<Object> sendPut(Object DataModelCarrierTransCapacity, UUID tracking, String queryParam, String token) {
        return null;
    }
  ...
  /**
     ...
     * @return サーバーからのレスポンス
     */
    public ResponseEntity<Void> sendPut_Void(Object dataModelCarrierTransCapacity, UUID tracking, String queryParam, String token) {
        ...
        ResponseEntity<Void> result;
            ...
            .body(dataModelCarrierTransCapacity)
            .retrieve()
            .toBodilessEntity(); 
            HttpStatusCode statusCode = result.getStatusCode();
            HttpHeaders headers = new HttpHeaders();
