...
@Schema(name = "dataModel_shipper_trans_capacity_attribute_msg_info", description = "メッセージ情報")
@JsonTypeName("dataModel_shipper_trans_capacity_attribute_msg_info")
...
public class DataModelShipperTransCapacityAttributeMsgInfo {
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo msgId(BigDecimal msgId) {
    this.msgId = msgId;
    return this;
  }
  ...
  */
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo msgInfoClsTypCd(String msgInfoClsTypCd) {
  ...
  */
  ...
  @Schema(name = "msg_info_cls_typ_cd", example = "5001", description = "情報区分コード", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo msgDateIssDttm(String msgDateIssDttm) {
  ...
  */
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo msgTimeIssDttm(BigDecimal msgTimeIssDttm) {
  ...
  */
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo msgFnStasCd(String msgFnStasCd) {
  ...
  */
  ...
  public DataModelShipperTransCapacityAttributeMsgInfo noteDcptTxt(String noteDcptTxt) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DataModelShipperTransCapacityAttributeMsgInfo dataModelShipperTransCapacityAttributeMsgInfo = (DataModelShipperTransCapacityAttributeMsgInfo) o;
    return Objects.equals(this.msgId, dataModelShipperTransCapacityAttributeMsgInfo.msgId) &&
        Objects.equals(this.msgInfoClsTypCd, dataModelShipperTransCapacityAttributeMsgInfo.msgInfoClsTypCd) &&
        Objects.equals(this.msgDateIssDttm, dataModelShipperTransCapacityAttributeMsgInfo.msgDateIssDttm) &&
        Objects.equals(this.msgTimeIssDttm, dataModelShipperTransCapacityAttributeMsgInfo.msgTimeIssDttm) &&
        Objects.equals(this.msgFnStasCd, dataModelShipperTransCapacityAttributeMsgInfo.msgFnStasCd) &&
        Objects.equals(this.noteDcptTxt, dataModelShipperTransCapacityAttributeMsgInfo.noteDcptTxt);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataModelShipperTransCapacityAttributeMsgInfo {\n");
